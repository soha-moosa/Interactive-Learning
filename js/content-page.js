...
let authCheckAndShowContent = () => {
  ...
  if (JSON.parse(localStorage.getItem('data'))) {
    ...
    for (var propName in data) {
      ...
      document.getElementById('courseContentDiv').innerHTML += '<div class="col l4 s12 m12"><div class="card black-grey darken-1"><div class="card-content black-text"><h1 class="card-title">' + propName + '</h1></div><button class="pink btn" onclick="hello()">Start</button</div>'
    }
    // for (key in data) {
